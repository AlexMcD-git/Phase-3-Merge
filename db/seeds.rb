...
bad_deeds=['robbing travelers','comminting murder', 'taking the last slice of cheesecake', 'general no-do-goodery', 'like, ruining the vibe, dude...']
...
25.times do
    ...
    enemy= Enemy.create(name: name_string, strength: rand(5..15), cunning: rand(5..15))
...
css=Enemy.create(name:"CSS", strength: 0, cunning: 250)
understand_css= Quest.create(description: "Do multiple css tasks correct on the first try.", gold_reward: css.strength+css.cunning, enemy:css, hero: dead_hero)
